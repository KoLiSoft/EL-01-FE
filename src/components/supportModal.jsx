  ...
  return (
    <div className="helpdlg" role="dialog" aria-modal="true" aria-labelledby="helpdlg-title">
      ...
      <div className="helpdlg__panel">
        <button className="helpdlg__close" aria-label="Đóng" onClick={onClose}>×</button>
            ...
            <li key={i} className="helpdlg__item">
              <div className="helpdlg__row">
                <div className="helpdlg__badge">
                  ...
                  <div className="helpdlg__badge-code">{it.code}</div>
                </div>

                <div className="helpdlg__body">
                  <div className="helpdlg__title">Gửi trợ giúp lần {it.attempt}</div>
                  <div className="helpdlg__meta">Ngày: {it.date}</div>

                  <button className="helpdlg__btn">Xem lại vấn đề</button>
                </div>

                <div className={`helpdlg__status helpdlg__status--${it.status}`}>
