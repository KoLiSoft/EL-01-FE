...
export default function USPSection() {
  const items = [
    { id: 1, title: "Tuyển chọn giáo viên kỹ lưỡng",
    ...
    { id: 2, title: "Lộ trình học cá nhân hóa",
    ...
    { id: 3, title: "Dạy tận tâm – đồng hành",
    ...
    { id: 4, title: "Theo dõi tiến độ học rõ ràng",
    ...
    { id: 6, title: "Hỗ trợ phụ huynh 24/7",
    ...
    <section className="usp-wrap">
      <div className="usp-left-copy">
        <h2>
          ...
          <br /><small>(Giá trị khác biệt – Unique Selling Point)</small>
        </h2>
