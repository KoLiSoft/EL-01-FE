          ...
          <div className="fc-track" ref={trackRef} onScroll={onTrackScroll}>
            {slides.map((group, si) => (
              <div className="fc-slide" key={si}>
                ...
                >
                  {group.map((item, i) => (
                    <article className="fc-card" key={`${si}-${i}`}>
                      <header className="fc-card__head">
                        <div className="fc-title">
                          <span className="fc-dot" aria-hidden="true"></span>
                          <h3>{item.title}</h3>
                        </div>
                        <div className="fc-rating" aria-label={`${item.stars} trên 5`}>
                          {'★★★★★'.slice(0, item.stars)}
                        </div>
                      </header>
                        ...
                        <li>
                          <span className="fc-ico" aria-hidden="true">
                            <svg viewBox="0 0 24 24" width="16" height="16">
                              <path d="M4 5h16a1 1 0 0 1 1 1v9a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1zm7 12h2v2h-2z" fill="currentColor"/>
                            </svg>
                          </span>
                          <span className="label">Hình thức:</span>
                          <span className="value">{item.form}</span>
                        </li>
                        <li>
                          <span className="fc-ico" aria-hidden="true">
                            <svg viewBox="0 0 24 24" width="16" height="16">
                              <path d="M12 7v5l3 2M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                            </svg>
                          </span>
                      ...
                      <div className="fc-actions">
                        ...
                        <button className="btn btn-orange btn-pill">Học thử 1 buổi</button>
                      </div>
                    </article>
                  ))}
                </div>
