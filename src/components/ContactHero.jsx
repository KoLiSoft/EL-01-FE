			...
			<div className="chero__inner">
				...
				<div className="chero__left">
					...
					<p className="chero__desc">
						Chúng tôi không chỉ dạy kiến thức – chúng tôi đồng hành cùng bạn
						trên cả hành trình học tập. Mỗi buổi học là một lần lắng nghe, thấu
						hiểu và trao trọn tâm huyết.
					</p>
				</div>
