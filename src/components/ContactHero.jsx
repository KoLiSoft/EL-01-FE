      ...
      <div className="chero__inner">
        ...
        <div className="chero__left">
          ...
          <p className="chero__desc">
            Chúng tôi không chỉ dạy kiến thức – chúng tôi đồng hành cùng bạn trên cả hành trình học tập.
            Mỗi buổi học là một lần lắng nghe, thấu hiểu và trao trọn tâm huyết.
          </p>
        </div>

        {/* BÊN PHẢI: form tư vấn */}
        <div className="chero__right">
          <h4 className="chero__formTitle">CÙNG BẠN BẮT ĐẦU HÀNH TRÌNH HỌC TẬP HIỆU QUẢ</h4>
          ...
          <form className="chero__form" onSubmit={(e)=>e.preventDefault()}>
            ...
            <button className="chero__btn" type="submit">Đăng ký tư vấn</button>
          </form>
        </div>
      </div>
    </section>
