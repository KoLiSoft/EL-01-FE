  ...
  return (
    <><BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/transactions" element={<Navigate to="/profile-std/wallet" replace />} />
        <Route path="/topup" element={<Navigate to="/profile-std/wallet/topup" replace />} />
        <Route path="/withdraw" element={<Navigate to="/profile-std/wallet/withdraw" replace />} />
        <Route path="/ewallet" element={<Navigate to="/profile-std/wallet/ewallet" replace />} />
