...
const SAMPLE = [
  ...
  },
  {
    ...
    tags: ['Character/Expression','Adobe Photoshop','Adobe Illustrator','Logo/Branding','Game/Animation concept','Vector Art'],
    rating: 4.9
  },
  {
    id: 5,
...
export default function TutorResults({ items ,inLayout = false }) {
  ...
  const formatVND = (n) =>
    typeof n === 'number' ? n.toLocaleString('vi-VN', { maximumFractionDigits: 0 }) : n;
  ...
  useEffect(() => { setPage(0); }, [sortKey, source.length]);
          ...
          >
            <span className="tr-sort__icon" aria-hidden="true">
              <svg viewBox="0 0 24 24" width="18" height="18">
                <path d="M4 7h10M4 12h16M4 17h8m6-10v4m-8 5v4"
          ...
          <article className="tr-card" key={t.id}>
            <header className="tr-head">
              ...
              <div className="tr-head__main">
                ...
                <div className="tr-chips">
                  <span className="tr-chip tr-chip--soft">Hiện là cộng tác viên</span>
                  <span className="tr-chip">Phù hợp</span>
                </div>
              </div>
              <div className="tr-head__meta">
                <div className="tr-rating" title={`${t.rating} sao`}>★★★★★</div>
            ...
            <div className="tr-rows">
              <div className="tr-row">
                ...
                <div className="tr-value">
                  <span className="tr-fee">
                    {formatVND(t.fee)}{t.feeUnit ? `/${t.feeUnit.split('/')[1]}` : ''}
                  </span>
                </div>
              </div>
              <div className="tr-row">
              ...
              <div className="tr-row">
                ...
                <div className="tr-value">Trình độ – <b>{t.degree}</b> • Kinh nghiệm – {t.exp}</div>
              </div>
              <div className="tr-row">
                <div className="tr-label">Môn lớp:</div>
                <div className="tr-value"><i>{t.subjectLine}</i></div>
              </div>
              <div className="tr-tags">
                {t.tags.map((tag, i) => <span className="tr-tag" key={i}>{tag}</span>)}
              </div>
            </div>
          ...
          <div className={`tr-sort ${sortOpen ? 'open' : ''}`}>
            ...
            >
              <span className="tr-sort__icon" aria-hidden="true">
                {/* icon sliders */}
                <svg viewBox="0 0 24 24" width="18" height="18">
                  <path d="M4 7h10M4 12h16M4 17h8m6-10v4m-8 5v4" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                </svg>
              </span>
              Sắp xếp bộ lọc
            </button>
            ...
            <article className="tr-card" key={t.id}>
              <header className="tr-head">
                ...
                <div className="tr-head__meta">
                  ...
                  <div className="tr-location">
                    <span className="tr-ico" aria-hidden="true">
                      <svg viewBox="0 0 24 24" width="14" height="14"><path d="M12 21s7-6.2 7-11a7 7 0 10-14 0c0 4.8 7 11 7 11z" fill="none" stroke="currentColor" strokeWidth="2"/></svg>
                    </span>
                    {t.district}
                  </div>
                  <div className="tr-location">
              ...
              <div className="tr-rows">
                ...
                <div className="tr-tags">
                  {t.tags.map((tag, i) => (
                    <span className="tr-tag" key={i}>{tag}</span>
                  ))}
                </div>
              </div>
