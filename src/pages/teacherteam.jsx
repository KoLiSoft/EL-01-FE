		...
		<>
			<div className="teacher-section">
				<div className="teacher-text">
					...
					<p>
						EdulinkTutor tự hào quy tụ đội ngũ giáo viên giỏi, tận tâm và được
						tuyển chọn kỹ lưỡng. Mỗi giáo viên không chỉ có chuyên môn vững vàng
						mà còn luôn đồng hành, truyền cảm hứng và giúp học viên tiến bộ rõ
						rệt qua từng buổi học.
					</p>
			...
			<section className="process">
				<div className="process-head">
					<h3 className="process-title">
						Quy Trình Chọn Giáo Viên
						<br />
						Tại Edulinktutor
					</h3>
					<p className="process-desc">
						EdulinkTutor cam kết mang đến quy trình chọn giáo viên rõ ràng, minh
						bạch và hiệu quả. Chúng tôi luôn đồng hành cùng phụ huynh và học
						viên trong suốt quá trình học tập để đảm bảo chất lượng và sự tiến
						bộ rõ rệt.
					</p>
				</div>
				...
				<div className="process-grid">
					<div className="process-card">
						...
						<div className="process-content">
							<h4>
								<span>Bước 1:</span> Gửi yêu cầu học
							</h4>
							<p>
								{" "}
								- Phụ huynh hoặc học viên điền thông tin môn học, thời gian, mục
								tiêu qua web, hotline hoặc Zalo.{" "}
							</p>
						</div>
					</div>
					<div className="process-card">
						...
						<div className="process-content">
							<h4>
								<span>Bước 2:</span> Tư vấn & gợi ý giáo viên phù hợp
							</h4>
							<p>
								- Tư vấn viên sẽ liên hệ trong vòng 24h.<br></br>- Gợi ý 2–3
								giáo viên phù hợp nhất dựa trên:<br></br>Trình độ - Kinh nghiệm
								- Thời gian rảnh - Mức phí phù hợp
							</p>
						</div>
					</div>
					<div className="process-card">
						...
						<div className="process-content">
							<h4>
								<span>Bước 3:</span> Xem hồ sơ giáo viên chi tiết
							</h4>
							<p>
								- Phụ huynh được xem: Thông tin cá nhân, bằng cấp môn dạy, lớp
								dạy, review từ học viên trước, video giới thiệu (nếu có)
							</p>
						</div>
					</div>
					<div className="process-card">
						...
						<div className="process-content">
							<h4>
								<span>Bước 4:</span> Học thử miễn phí buổi đầu
							</h4>
							<p>
								- Giáo viên sẽ dạy buổi đầu không tính phí.<br></br>- Nếu phù
								hợp thì tiếp tục, không thì EdulinkTutor hỗ trợ đổi giáo viên
								miễn phí.
							</p>
						</div>
					</div>
					<div className="process-card">
						...
						<div className="process-content">
							<h4>
								<span>Bước 5:</span> Chính thức bắt đầu khóa học
							</h4>
							<p>
								- Đăng ký học chính thức (online )<br></br>- Edulinktutor hỗ trợ
								theo sát trong suốt quá trình học.
							</p>
						</div>
					</div>
					<div className="process-card">
						...
						<div className="process-content">
							<h4>
								<span>Bước 6:</span> Đánh giá và phản hồi sau khóa học
							</h4>
							<p>
								- Kết thúc khóa học, phụ huynh/học viên được đánh giá giáo viên.
								<br></br>- EdulinkTutor thu thập ý kiến để cải thiện chất lượng
								dịch vụ.
							</p>
						</div>
					</div>
