                ...
                <>
                        <div className="teacher-section">
                                <div className="teacher-text">
                                        ...
                                        <p>
                                                EdulinkTutor tự hào quy tụ đội ngũ giáo viên giỏi, tận tâm và được tuyển
                                                chọn kỹ lưỡng. Mỗi giáo viên không chỉ có chuyên môn vững vàng mà còn
                                                luôn đồng hành, truyền cảm hứng và giúp học viên tiến bộ rõ rệt qua từng
                                                buổi học.
                                        </p>
                        ...
                        <section className="process">
                                <div className="process-head">
                                        ...
                                        <p className="process-desc">
                                                ...
                                                bạch và hiệu quả. Chúng tôi luôn đồng hành cùng phụ huynh và học viên
                                                trong suốt quá trình học tập để đảm bảo chất lượng và sự tiến bộ rõ rệt.
                                        </p>
                                </div>
                                ...
                                <div className="process-grid">
                                        <div className="process-card">
                                                ...
                                                <div className="process-content">
                                                        ...
                                                        <p>
                                                                {" "}
                                                                - Phụ huynh hoặc học viên điền thông tin môn học, thời
                                                                gian, mục tiêu qua web, hotline hoặc Zalo.{" "}
                                                        </p>
                                                </div>
                                        </div>
                                        <div className="process-card">
                                                ...
                                                <div className="process-content">
                                                        ...
                                                        <p>
                                                                - Tư vấn viên sẽ liên hệ trong vòng 24h.<br></br>- Gợi ý
                                                                2–3 giáo viên phù hợp nhất dựa trên:<br></br>Trình độ -
                                                                Kinh nghiệm - Thời gian rảnh - Mức phí phù hợp
                                                        </p>
                                                </div>
                                        </div>
                                        <div className="process-card">
                                                ...
                                                <div className="process-content">
                                                        ...
                                                        <p>
                                                                - Phụ huynh được xem: Thông tin cá nhân, bằng cấp môn
                                                                dạy, lớp dạy, review từ học viên trước, video giới thiệu
                                                                (nếu có)
                                                        </p>
                                                </div>
                                        </div>
                                        <div className="process-card">
                                                ...
                                                <div className="process-content">
                                                        ...
                                                        <p>
                                                                - Giáo viên sẽ dạy buổi đầu không tính phí.<br></br>-
                                                                Nếu phù hợp thì tiếp tục, không thì EdulinkTutor hỗ trợ
                                        ...
                                        <div className="process-card">
                                                ...
                                                <div className="process-content">
                                                        ...
                                                        <p>
                                                                - Đăng ký học chính thức (online )<br></br>-
                                                                Edulinktutor hỗ trợ theo sát trong suốt quá trình học.
                                                        </p>
                                                </div>
                                        </div>
                                        <div className="process-card">
                                                ...
                                                <div className="process-content">
                                                        ...
                                                        <p>
                                                                - Kết thúc khóa học, phụ huynh/học viên được đánh giá
                                                                giáo viên.
                                                                <br></br>- EdulinkTutor thu thập ý kiến để cải thiện
                                                                chất lượng dịch vụ.
                                                        </p>
                                                </div>
                                        </div>
