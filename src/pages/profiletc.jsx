    ...
    <div className="prtc">
      ...
      <aside className="prtc__sidebar">
        ...
        <nav className="prtc__sidebar-nav">
          <a className="prtc__nav-item prtc__nav-item--active" href="#">Thông tin cá nhân</a>
          <a className="prtc__nav-item" href="#">Tài liệu</a>
          <a className="prtc__nav-item" href="#">Cài đặt</a>
          <a className="prtc__nav-item" href="#">Ví</a>
        </nav>
      </aside>
      ...
      <main className="prtc__content">
        <div className="prtc__card">
          ...
          <div className="prtc__section-heading">
            ...
            <button className="prtc__link-btn" type="button">Chỉnh sửa</button>
          </div>
          ...
          <form className="prtc__grid">
            ...
            <div className="prtc__field prtc__field--textarea" style={{gridColumn: '1 / -1'}}>
              <label>Kinh nghiệm làm việc</label>
              <textarea placeholder="Kinh nghiệm làm việc" rows="4"></textarea>
            </div>
          </form>
