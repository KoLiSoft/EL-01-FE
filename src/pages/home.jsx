	...
	const questions = [
		{
			...
			answer:
				"Giáo viên của chúng tôi sẽ đồng hành cùng bạn từ kiến thức nền tảng đến nâng cao.",
		},
		{
		...
		},
		{
			...
			answer:
				"Đội ngũ tư vấn học tập sẽ giúp bạn xây lộ trình phù hợp với mục tiêu của bạn.",
		},
		{
			question: "Bạn từng mất gốc – học lại nhiều lần không hiệu quả?",
			answer:
				"Phương pháp dạy dễ hiểu, từ từ xây nền vững chắc, lấy lại sự tự tin.",
		},
	];
	return (
		<>
			...
			<section className="study-support-section">
				...
				<div className="support-right">
					...
					<p className="support-subtitle">
						“Từ học sinh mất gốc đến học sinh giỏi, EdulinkTutor đều có lộ trình
						học cá nhân hóa dành cho bạn.”
					</p>
